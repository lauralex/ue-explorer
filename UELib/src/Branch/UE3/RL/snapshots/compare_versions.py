...
V868_TABLE = {
    ...
    0x01: (0x7FF6CD2F0FB0, "StateVariableToken",        "2 sub-exprs"),
    ...
    0x07: (0x7FF6CD2F7360, "ReturnNothingToken",        "tail-call wrapper"),
    0x09: (0x7FF6CD2F5930, "DiscardKeepTokenRL",        "optional 0x20 + 2 sub-exprs"),
    0x0B: (0x7FF6CD2F6DC0, "IntConstToken",             "4-byte INT"),
    0x0C: (0x7FF6CD2F0AA0, "EventSubscribeToken",       "2 sub + bit-clear (LetBool-shape)"),
    ...
    0x12: (0x7FF6CD2F5740, "EatReturnValueToken",       "variadic body until 0x3E"),
    0x13: (0x7FF6CD2ED3E0, "NoObjectToken",             "NoObject-shape"),
    0x15: (0x7FF6CD2F59D0, "InterfaceContextToken",     "1 sub + write 0"),
    0x16: (0x7FF6CD2F6800, "DynamicArrayElementToken",  "alias 0x05"),
    0x17: (0x7FF6CD2F1580, "DelegateAccessTokenRL",     "2 sub + delegate-list walk"),
    ...
    0x33: (0x7FF6CD2F1770, "EatReturnValueToken",       "2 sub + dynarray-result handling"),
    ...
    0x3B: (0x7FF6CD2F6FA0, "ObjectConstToken",          "alias 0x39"),
    ...
    0x48: (0x7FF6CD30D7C0, "EventSubscribeToken",       "delegate subscribe"),
    0x49: (0x7FF6CD2F0C60, "LetDelegateToken",          "2 sub + delegate cleanup"),
    0x4A: (0x7FF6CD2F6590, "StructMemberToken",         "UProperty + UStruct + 2 bytes + sub"),
    0x4C: (0x7FF6CD2F08B0, "LetToken",                  "2 sub + assign-through-None log"),
