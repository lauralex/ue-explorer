...
public class ExtendedNativeFunctionToken : UStruct.UByteCodeDecompiler.Token
{
    ...
    private static readonly TokenMap s_extendedNativeFunctionTokenMap = new()
    {
        ...
        { 0x02, typeof(UStruct.UByteCodeDecompiler.DynamicArrayInsertToken) },
        { 0x03, typeof(UStruct.UByteCodeDecompiler.DynamicArrayRemoveToken) },
        ...
        { 0x09, typeof(UStruct.UByteCodeDecompiler.DynamicArrayInsertItemToken) },
        { 0x0A, typeof(DynamicArrayIteratorRL) },
        { 0x0B, typeof(VariadicArrayConcatTokenRL) },
        { 0x0C, typeof(VariadicArrayAddUniqueItemsRL) },
        { 0x0D, typeof(DynamicArrayAddUniqueItemTokenRL) },
        { 0x0E, typeof(UStruct.UByteCodeDecompiler.DynamicArraySortToken) },
        { 0x0F, typeof(UStruct.UByteCodeDecompiler.DynamicArraySortToken) },
        { 0x20, typeof(DynamicArraySortedCopyTokenRL) },
        { 0x21, typeof(DynamicArrayFilterOutTokenRL) },
        { 0x22, typeof(DynamicArrayMapTokenRL) },
        { 0x23, typeof(DynamicArrayReduceTokenRL) },
        { 0x24, typeof(FindFirstWithDelegate) },
        { 0x25, typeof(DynamicArrayEveryTokenRL) },
        { 0x26, typeof(DynamicArrayAnyTokenRL) },
        { 0x27, typeof(DynamicArrayConcatTokenRL) },
        { 0x28, typeof(VariadicArrayFillOutTokenRL) },
        { 0x29, typeof(DynamicArrayFilterTokenRL) },
        { 0x2A, typeof(DynamicArrayDistinctTokenRL) },
        { 0x2B, typeof(DynamicArrayFirstTokenRL) },
        { 0x2C, typeof(DynArrayEqualToken) },
        { 0x2E, typeof(DynamicArrayOfTypeTokenRL) },
        { 0x2F, typeof(DynamicArrayFlatMapTokenRL) },
        { 0x30, typeof(DynamicArrayFindTypeTokenRL) },
        { 0x31, typeof(DynamicArrayConcatTokenRL) },
        { 0x32, typeof(DynamicArrayIntersectTokenRL) },
        { 0x33, typeof(DynamicArrayDifferenceTokenRL) },
        { 0x34, typeof(DynamicArrayToStringTokenRL) },
        { 0x35, typeof(DynamicArrayLastTokenRL) },
    };
